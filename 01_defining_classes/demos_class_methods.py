...
class Circle:
    # create class attr `max_radius` and set it to 100.
    max_radius = 100

    # class Circle has an init method that takes self and raduis.
    ...
    # Class Circle has a static method named `is_rad...` that takes radius.
    @staticmethod
